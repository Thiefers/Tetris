...
public class NormalJPanel extends JPanel implements MouseListener {
	/** 下落方块 */
	...
	static {
		try {
			index = Tool.getIcon("graphics//17.png").getImage();
			background = Tool.getIcon("graphics//tetrisBg.png").getImage();
	 ...
	 * @param cardLayout
	 */
	public NormalJPanel(JPanel mainJPanel, CardLayout cardLayout) {
		// TODO 自动生成的构造函数存根
